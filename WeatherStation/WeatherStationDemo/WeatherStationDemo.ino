 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "freebox_LVUDAH";
const char* WIFI_PWD = "opacare-inclamamus42-recisurum-sociandos6";
...
const char *api_key ="DTSCW3GOC80Z0OTV";                  //Your own thingspeak api_key
...
String OPEN_WEATHER_MAP_APP_ID = "8760d3c33303a1b01128cb1063dcc73b";
String OPEN_WEATHER_MAP_LOCATION = "Yerres,FR";
